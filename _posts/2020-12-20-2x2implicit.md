...
$$\begin{equation} \tag{18} \label{polar1}
u_1=r\cos(\theta),\quad u_2=r\sin(\theta)
\end{equation}$$

From (\ref{polar1}) we can deduce that

$$\begin{equation} \tag{19} \label{polar2}
...
We manipulate this equation to get it in terms of $$u_1$$ and $$u_2$$ using what we know from (\ref{polar2}).
...
Returning to $$x$$ and $$y$$ by reversing (\ref{complexusub}) and simplifying a bit using the arbitrary constant,
